                    ...
                    begin
                        ...
                        if Rec.ISA_TradeRegister <> '' then begin
                            ...
                            if Customers.Count > 1 then begin
                                ...
                                TradeRegisterNotification.AddAction(ShowDetailsLbl, Codeunit::ISA_ToolBox, 'OpenCustomersListTradeRegister');
                    ...
                    begin
                        ...
                        if Rec.ISA_FiscalID <> '' then begin
                            ...
                            if Customers.Count > 1 then begin
                                ...
                                FiscalIDNotification.AddAction(ShowDetailsLbl, Codeunit::ISA_ToolBox, 'OpenCustomersListFiscalID');
                    ...
                    begin
                        ...
                        if Rec.ISA_StatisticalID <> '' then begin
                            ...
                            if Customers.Count > 1 then begin
                                ...
                                StatisticalIDNotification.AddAction(ShowDetailsLbl, Codeunit::ISA_ToolBox, 'OpenCustomersListStatisticalID');
                    ...
                    begin
                        ...
                        if Rec.ISA_ItemNumber <> '' then begin
                            ...
                            if Customers.Count > 1 then begin
                                ...
                                ItemNumberNotification.AddAction(ShowDetailsLbl, Codeunit::ISA_ToolBox, 'OpenCustomersListItemNumber');
