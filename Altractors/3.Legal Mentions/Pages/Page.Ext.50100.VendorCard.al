                    ...
                    begin
                        ...
                        if Rec.ISA_TradeRegister <> '' then begin
                            ...
                            if Vendors.Count > 1 then begin
                                ...
                                TradeRegisterNotification.AddAction(ShowDetailsLbl, Codeunit::ISA_ToolBox, 'OpenVendorsListTradeRegister');
                    ...
                    begin
                        ...
                        if Rec.ISA_FiscalID <> '' then begin
                            ...
                            if Vendors.Count > 1 then begin
                                ...
                                FiscalIDNotification.AddAction(ShowDetailsLbl, Codeunit::ISA_ToolBox, 'OpenVendorsListFiscalID');
                    ...
                    begin
                        ...
                        if Rec.ISA_StatisticalID <> '' then begin
                            ...
                            if Vendors.Count > 1 then begin
                                ...
                                StatisticalIDNotification.AddAction(ShowDetailsLbl, Codeunit::ISA_ToolBox, 'OpenVendorsListStatisticalID');
                    ...
                    begin
                        ...
                        if Rec.ISA_ItemNumber <> '' then begin
                            ...
                            if Vendors.Count > 1 then begin
                                ...
                                ItemNumberNotification.AddAction(ShowDetailsLbl, Codeunit::ISA_ToolBox, 'OpenVendorsListItemNumber');
