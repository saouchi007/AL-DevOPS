/// <summary>
/// PageExtension ISA_ServiceMgmtSetup_Ext (ID 50107) extends Record Service Mgt. Setup.
/// </summary>
pageextension 50123 ISA_ServiceMgmtSetup_Ext extends "Service Mgt. Setup"
{
    layout
    {
        addafter(General)
