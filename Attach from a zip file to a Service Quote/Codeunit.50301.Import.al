/// <summary>
/// Codeunit ISA_Import (ID 50301).
/// </summary>
codeunit 50301 ISA_Import
{
    trigger OnRun()
    begin
    end;
    ...
    /// </summary>
    /// <param name="SalesHeader">VAR Record "Service Header".</param>
    procedure ImportAttachmentsFromZip(var SalesHeader: Record "Service Header")
    var
