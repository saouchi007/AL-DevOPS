/// <summary>
/// PageExtension CustomerList_Ext (ID 50148) extends Record Customer List.
/// </summary>
pageextension 50148 CustomerList_Ext extends "Customer List"
{
    actions
    {
        addfirst(processing)
        {
            action(ImportZipFile)
            {
                ...
                ToolTip = 'Import Attachments from Zip file';
