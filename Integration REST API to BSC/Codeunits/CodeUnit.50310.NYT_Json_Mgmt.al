/// <summary>
/// Codeunit ISA_NYT_Json_Mgmt (ID 50310).
/// </summary>
codeunit 50310 ISA_NYT_Json_Mgmt
{
    ...
    /// <summary>
    /// UpdateBestSellersTheme.
    /// </summary>
    /// <param name="Data">text.</param>
    procedure UpdateBestSellersTheme(Data: text)
    var
        NYTBestSellersTheme: Record ISA_NYT_Best_Sellers_Theme;
        JToken: JsonToken;
        JObject: JsonObject;
        JArray: JsonArray;
    begin
        ...
        foreach JToken in JArray do begin
            ...
            NYTBestSellersTheme.ListName := CopyStr(GetValueAsText(JToken, 'list_name'), 1, MaxStrLen(NYTBestSellersTheme.ListName));
            ...
            NYTBestSellersTheme.OldestPublishedDate := DT2Date(EvaluateUTCDateTime(GetValueAsText(JToken, 'oldest_published_date')));
