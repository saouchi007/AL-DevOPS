codeunit 81557 "MICA Process Mass Payment CO"
{
    ...
    var
        ...
        XmlMICACOMPpain00100103: XmlPort "MICA CO MP pain.001.001.03";
            ...
            repeat
                ...
                if not FromPmtGenJournalLine.IsEmpty() then begin
                    ...
                    if MICAFlowEntry.Get(MICAFlow.CreateFlowEntry()) then begin
                        ...
                        Clear(XmlMICACOMPpain00100103);
                        XmlMICACOMPpain00100103.SetDestination(OutStream);
                        XmlMICACOMPpain00100103.SetTableView(FromPmtGenJournalLine);
                        if XmlMICACOMPpain00100103.Export() then begin
