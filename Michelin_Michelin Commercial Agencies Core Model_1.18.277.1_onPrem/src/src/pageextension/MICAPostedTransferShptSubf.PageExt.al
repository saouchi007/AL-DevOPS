pageextension 81463 "MICA Posted Transfer Shpt.Subf" extends "Posted Transfer Shpt. Subform"
{
    layout
    {
        addlast(Control1)
        {
            ...
            field("MICA Ship From Vendor"; Rec."MICA Ship From Vendor")
            {
                ApplicationArea = All;
            }
            field("MICA Shipment Line Num"; Rec."MICA Shipment Line Num")
            {
                ApplicationArea = All;
            }
            field("MICA Initial Shipment Date"; Rec."MICA Initial Shipment Date")
            {
                ApplicationArea = All;
            }
