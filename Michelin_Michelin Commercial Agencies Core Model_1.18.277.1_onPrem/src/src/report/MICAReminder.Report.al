report 80700 "MICA Reminder"
{
    // version NAVW113.01,SPLN1.00

    // SPLN1.00 ALI 2019-02-21 Changed design
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/Rdl80700.MICAReminder.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Reminder Custom';
    ...
    dataset
    {
        dataitem("Issued Reminder Header"; "Issued Reminder Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(CompanyInfo2Picture; CalcPicCompanyInformation.Picture)
                {
                }
                column(CompanyInfo3Picture; PicCompanyInformation.Picture)
                {
                }
                ...
                column(CurrReportPageNo; StrSubstNo(Text002Lbl, CurrReport.PageNo()))
                {
                }
                ...
                column(IBANCaption; CompanyInformation.FieldCaption(IBAN))
                {
                }
                column(CurrencyCode; "Issued Reminder Header"."Currency Code")
                {
                }
                column(CurrencyCodeCaption; "Issued Reminder Header".FieldCaption("Currency Code"))
                {
                }
                ...
                dataitem(DimensionLoop; "Integer")
                {
                    ...
                    begin
                        if not ShowInternalInfoValue then
                            CurrReport.Break();
                    end;
                }
                dataitem("Issued Reminder Line"; "Issued Reminder Line")
                {
                    ...
                    column(ShowInternalInfo; ShowInternalInfoValue)
                    {
                    }
                    ...
                    begin
                        ...
                        Clear(CalcPicCompanyInformation.Picture);
                        ...
                        if FindLast() then begin
                            ...
                            repeat
                                Continue :=
                                  not ShowNotDueAmountsValue and
                ...
                dataitem(IssuedReminderLine2; "Issued Reminder Line")
                {
                    ...
                    begin
                        SetFilter("Line No.", '>=%1', EndLineNo);
                        if not ShowNotDueAmountsValue then begin
                ...
                dataitem(VATCounterLCY; "Integer")
                {
                    ...
                    begin
                        ...
                        if GeneralLedgerSetup."LCY Code" = '' then
                            ...
                            VALSpecLCYHeader := Text011Lbl + Format(GeneralLedgerSetup."LCY Code");

                        CurrencyExchangeRate.FindCurrency("Issued Reminder Header"."Posting Date", "Issued Reminder Header"."Currency Code", 1);
                        CustLedgerEntry.SetRange("Customer No.", "Issued Reminder Header"."Customer No.");
                        CustLedgerEntry.SetRange("Document Type", CustLedgerEntry."Document Type"::Reminder);
                        CustLedgerEntry.SetRange("Document No.", "Issued Reminder Header"."No.");
                        if CustLedgerEntry.FindFirst() then begin
                            CustLedgerEntry.CalcFields("Amount (LCY)", Amount);
                            CurrFactor := 1 / (CustLedgerEntry."Amount (LCY)" / CustLedgerEntry.Amount);
                            VALExchRate := CopyStr(StrSubstNo(Text013Lbl, Round(1 / CurrFactor * 100, 0.000001), CurrencyExchangeRate."Exchange Rate Amount"), 1, 50);
                        end else begin
                            CurrFactor := CurrencyExchangeRate.ExchangeRate("Issued Reminder Header"."Posting Date", "Issued Reminder Header"."Currency Code");
                            VALExchRate := CopyStr(StrSubstNo(Text013Lbl, CurrencyExchangeRate."Relational Exch. Rate Amount", CurrencyExchangeRate."Exchange Rate Amount"), 1, 50);
                        end;
                    end;
                }
            ...
            begin
                ...
                if "VAT Registration No." = '' then
                    ...
                    VATNoText := CopyStr(FieldCaption("VAT Registration No."), 1, 30);
                if "Currency Code" = '' then begin
                    GeneralLedgerSetup.TestField("LCY Code");
                    TotalText := CopyStr(StrSubstNo(Text000Lbl, GeneralLedgerSetup."LCY Code"), 1, 50);
                    TotalInclVATText := CopyStr(StrSubstNo(Text001Lbl, GeneralLedgerSetup."LCY Code"), 1, 50);
                end else begin
                    TotalText := CopyStr(StrSubstNo(Text000Lbl, "Currency Code"), 1, 50);
                    TotalInclVATText := CopyStr(StrSubstNo(Text001Lbl, "Currency Code"), 1, 50);
                end;
                CurrReport.PageNo := 1;
            ...
            begin
                ...
                //dmt FormatAddr.Company(CompanyAddr, CompanyInfo); 
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(ShowInternalInfo; ShowInternalInfoValue)
                    {
                    ...
                    field(ShowNotDueAmounts; ShowNotDueAmountsValue)
                    {
                        ApplicationArea = Basic, Suite;
        ...
        trigger OnOpenPage()
        begin
            LogInteractionValue := SegManagement.FindInteractTmplCode(8) <> '';
    ...
    begin
        ...
        case SalesReceivablesSetup."Logo Position on Documents" of
            ...
            SalesReceivablesSetup."Logo Position on Documents"::Center:
                begin
                    CalcPicCompanyInformation.Get();
                    CalcPicCompanyInformation.CalcFields(Picture);
                end;
    ...
    var
        ...
        CalcPicCompanyInformation: Record "Company Information";
        ...
        ShowNotDueAmountsValue: Boolean;
