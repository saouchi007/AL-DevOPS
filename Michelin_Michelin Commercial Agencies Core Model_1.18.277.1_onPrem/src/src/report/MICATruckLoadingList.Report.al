report 80103 "MICA Truck Loading List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/MICATruckLoadingList.rdlc';
    Caption = 'Truck Loading List';
    UsageCategory = None;
    ...
    dataset
    {
        dataitem("Warehouse Activity Header"; "Warehouse Activity Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(PickingListCaption; TruckLoadingListCaptionLbl)
                {
                }
                ...
                dataitem("Warehouse Activity Line"; "Warehouse Activity Line")
                {
                    ...
                    DataItemTableView = SORTING("Activity Type", "No.", "Destination Type", "Destination No.", "Action Type", "Bin Code");
    ...
    var
        ...
        TruckLoadingListCaptionLbl: Label 'Truck Loading List';
