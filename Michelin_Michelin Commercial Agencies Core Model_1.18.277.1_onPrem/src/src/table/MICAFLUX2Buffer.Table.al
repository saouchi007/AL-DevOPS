table 80660 "MICA FLUX2 Buffer"
{
    ...
    keys
    {
        key(PK; "Group Account No.", Interco, Section, Structure, "Invoice Currency")
        {
            Clustered = true;
        }
    }
    /*
        ...
        var
            ...
            Flux2Buffer: Record "MICA FLUX2 Buffer";
        ...
        local procedure Flux2BufferInsert(var Flux2Buffer: Record "MICA FLUX2 Buffer"; Flux2BufferQuery: Query "MICA FLUX2 Buffer"; AccountNo: Code[4]; SectionCode: Code[6]; CurrencyCode: Code[10]; CompanyCode: Code[3]; EndingPeriod: Date)
        begin
            Flux2Buffer.Init();
        ...
        local procedure Flux2BufferModify(var Flux2Buffer: Record "MICA FLUX2 Buffer"; Flux2BufferQuery: Query "MICA FLUX2 Buffer")
        begin
            Flux2Buffer."Amount LCY" += Flux2BufferQuery.SumAmountLCY;
            Flux2Buffer."Invoice Amount" += Flux2BufferQuery.SumAmountFCY;
            Flux2Buffer.Modify();
