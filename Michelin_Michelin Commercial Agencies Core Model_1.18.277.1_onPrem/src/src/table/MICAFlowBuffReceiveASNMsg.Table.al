table 81500 "MICA FlowBuff Receive ASN Msg"
{
    //INT-DOO-002: ASN message integration (In)
    ...
    fields
    {
        ...
        field(81501; No; Code[35])
        {
            DataClassification = CustomerContent;
        }
        field(81502; "Line_No"; Integer)
        {
            DataClassification = CustomerContent;
        }
        ...
        field(81505; "ASN_Date"; Date)
        {
            DataClassification = CustomerContent;
        }
        field(81506; Quantity; Decimal)
        {
            DataClassification = CustomerContent;
        }
    }
