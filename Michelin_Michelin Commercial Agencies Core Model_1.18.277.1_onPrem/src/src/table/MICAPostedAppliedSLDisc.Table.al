table 80187 "MICA Posted Applied SL Disc."
{
    // version OFFINVOICE
    DataClassification = CustomerContent;
    Caption = 'Posted Applied Sales Line Disc.';
    LookupPageId = "MICA Posted Applied SL Disc";
    DrillDownPageId = "MICA Posted Applied SL Disc";
    ...
    fields
    {
        ...
        field(200; "Posted Document No."; Code[20])
        {
            Caption = 'Posted Document No.';
            DataClassification = CustomerContent;
        }
        field(210; "Posted Document Line No."; Integer)
        {
            Caption = 'Posted Document Line No.';
            DataClassification = CustomerContent;
        }
        field(250; "Posted Document Type"; Option)
        {
        ...
        field(310; "Order Date"; Date)
        {
            Caption = 'Order Date';
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Invoice Header"."Order Date" WHERE("No." = field("Posted Document No.")));
            Editable = false;
        }
        field(320; "MICA Status"; Option)
        {
            Caption = 'Status';
            OptionMembers = Open,"Reserve OnHand","Reserve InTransit","Waiting Allocation","Send to Execution",Closed;
            Editable = false;
    ...
    keys
    {
        ...
        key(Key4; "Posted Document Type", "Posted Document No.", "Posted Document Line No.")
        {
        }
        key(Key5; "Posted Document Type", "Posted Document No.", "Posted Document Line No.", "Rebates Type")
        {
        }
