tableextension 81466 "MICA Transfer Receipt Header" extends "Transfer Receipt Header"
{
    fields
    {
        ...
        field(82000; "MICA ARSTOCK Integrated"; Boolean)
        {
            Caption = 'ARSTOCK Integrated';
            DataClassification = CustomerContent;
            Editable = false;
        }
