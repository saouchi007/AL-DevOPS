tableextension 82870 "Sales Invoice Line Aggregate" extends "Sales Invoice Line Aggregate"
{
    fields
    {
        ...
        field(80003; "MICA Planned Delivery Date"; Date)
        {
            Caption = 'Planned Delivery Date';
            DataClassification = CustomerContent;
            Editable = false;
        }
        field(80004; "MICA Planned Shipment Date"; Date)
        {
