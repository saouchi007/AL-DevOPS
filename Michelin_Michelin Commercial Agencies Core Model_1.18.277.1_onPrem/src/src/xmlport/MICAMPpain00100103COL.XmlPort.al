xmlport 81552 "MICA MP pain.001.001.03 COL"
{
    // version MIC01.00.18
                                        ...
                                        textelement(TaxId)
                                        {
                                            ...
                                            begin
                                                if Vend.Get(paymentexportdata."Recipient ID") then
                                                    TaxId := Vend."VAT Registration No.";
                                            end;
                                        }
                                        textelement(SchmeNm)
                                        {
    ...
    begin
        ...
        InsertPmtGroup(PaymentGroupNo);
        CtrlSum := Format(PaymentExportDataGroup.Amount);
        CtrlSum2 := Format(PaymentExportDataGroup.Amount);
    end;
