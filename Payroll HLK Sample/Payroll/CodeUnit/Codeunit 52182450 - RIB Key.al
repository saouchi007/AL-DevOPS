/// <summary>
/// Codeunit RIB Key (ID 52182450).
/// </summary>
codeunit 52182450 "RIB Key"
{
    ...
    /// Check.
    /// </summary>
    /// <param name="Bank">Text.</param>
    /// <param name="Agency">Text.</param>
    /// <param name="Account">Text.</param>
    /// <param name="RIBKey">Integer.</param>
