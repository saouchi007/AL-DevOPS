/// <summary>
/// PageExtension ISA_ServiceInvStats_Ext (ID 50110) extends Record Service Statistics.
/// </summary>
pageextension 50110 ISA_ServiceQuoteStats_Ext extends "Service Statistics"
{
    layout
    {
