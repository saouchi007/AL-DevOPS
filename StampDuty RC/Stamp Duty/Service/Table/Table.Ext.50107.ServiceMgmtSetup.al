/// <summary>
/// TableExtension ISA_ServiceMgmtSetup_Ext (ID 50107) extends Record Service Mgt. Setup.
/// </summary>
tableextension 50107 ISA_ServiceMgmtSetup_Ext extends "Service Mgt. Setup"
{
    fields
    {
